...
$res = $prospecto->setProspecto($nombreEmpresa, $nombreContacto, $cargoContacto, $telefono, $oportunidad, $fechaCita, $horaCita, $idUsuario);
$array['state'] = 'false';
$array['message'] = 'Prospecto no guardado';
if ($res) {
        $array['message'] = 'Prospecto guardado exitosamente';
        $array['state'] = 'true';
}
